...
public record BroglisOwlsEntityBiomeModifier(HolderSet<Biome> biomes, MobSpawnSettings.SpawnerData spawnerData) implements BiomeModifier {
    @Override
    ...
    public Codec<? extends BiomeModifier> codec() {
        return BroglisOwlsBiomeModifiers.ENTITY_MODIFIER.get();
    }
}
